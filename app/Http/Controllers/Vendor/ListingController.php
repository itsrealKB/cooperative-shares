...
class ListingController extends Controller
{
    ...
    {
        $states = State::all();
        return view('screens.vendor.listings.create', compact('states'));
    }
    ...
    {
        $states = State::all();
        $listingState = State::where('name', $listing->state)->first();
        $cities = City::where('state_id', $listingState->id)->get();
        return view('screens.vendor.listings.edit', get_defined_vars());
    }
