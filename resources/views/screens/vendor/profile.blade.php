            ...
            <div class="row">
                ...
                <div class="col-xxl-9 col-xl-8">
                    ...
                    <form>
                        <div class="form-group mb-3">
                            ...
                            <div>:</div>
                            <input class="input-area" type="text" class="form-control" placeholder="First Name">
                        </div>
                        <div class="form-group mb-3">
                            <label>Last Name <span class="text-danger">*</span></label>
                            <div>:</div>
                            <input class="input-area" type="text" class="form-control" placeholder="Last Name">
                        </div>
                        <div class="form-group mb-3">
                            <label>Email address<span class="text-danger">*</span></label>
                            <div>:</div>
                            <input class="input-area" type="email" class="form-control" placeholder="Email Address">
                        </div>
                        <div class="form-group mb-3">
                            <label>Phone Number<span class="text-danger">*</span></label>
                            <div>:</div>
                            <input class="input-area" type="text" class="form-control" placeholder="Phone Number">
                        </div>
                        <div class="form-group mb-3">
                            <label>Address</label>
                            <div>:</div>
                            <input class="input-area" type="text" class="form-control" placeholder="Address">
                        </div>
                        <div class="form-group form-textarea-group mb-3">
                            <label>Description</label>
                            <div>:</div>
                            <textarea class="input-area" class="form-control" placeholder="Description"></textarea>
                        </div>
                ...
                <div class="col-xxl-3 col-xl-4">
                    <div class="profile-card shadow-sm text-center">
                        <!-- Profile Image -->
                        <img id="profileImage" src="{{ asset('assets/vendor/images/person-img.png') }}" alt="Profile"
