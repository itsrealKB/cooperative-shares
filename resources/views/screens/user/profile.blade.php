                ...
                <div class="col-xxl-3 col-xl-4">
                    <div class="profile-card shadow-sm text-center">
                        ...
                        <img id="profileImage" onclick="document.getElementById('imageInput').click()"
                            ...
                            src="{{ ($user->profile_image) ? asset('storage/' . $user->profile_image) : asset('assets/dummy_avatar/avatar.jpg') }}"
                            alt="Profile" class="img-fluid rounded mb-2" style="max-height: 180px; object-fit: cover;">
    ...
    <script>
        $(document).ready(function () {
            $('#profile-pic-form').on('submit', function (e) {
                ...
                let formData = new FormData(this);
                $.ajax({
                    url: "{{ route('user.profileImage.store') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
    ...
    <script>
        $(document).ready(function () {
            $('#deleteProfilePic').on('click', function(){
                ...
                $.ajax({
                    url: "{{ route('user.profileImage.destory') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
